...
\begin{document}
    ...
    % ================================================================
    % ADD CHAPTERS HERE
    \input{chapters/chap 1. Introduction générale.tex}
    \input{chapters/chap 2. Outils mathématiques pour la reconstruction d'image.tex}
    \input{chapters/chap 3. Quelques modèles de reconstruction.tex}
