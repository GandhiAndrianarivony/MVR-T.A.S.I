\chapter{Approche ADMM associée aux ondelettes biorthogonales 4.4}
\label{chapitre3} 
...
\begin{equation}\psi_{a,T}(t) = \frac{1}{\sqrt{a}}\psi \left(\frac{t - T}{a}\right) \quad (5)\end{equation}
...
L'ondelette orthogonale est liée à la transformée en ondelettes, et elles sont orthogonales entre elles. L'orthogonalité évite les interférences afin qu'une sortie sans erreur puisse être obtenue. \newpage Grâce à ces caractéristiques, elle est le plus souvent préférable. Une ondelette orthogonale est l'adjoint de la transformée en ondelettes. Une fonction d'échelle unique avec une ondelette unique est le résultat d'une ondelette orthogonale.\\
...
\subsection{Résolution du problème inverse CT par régularisation parcimonieuse}
